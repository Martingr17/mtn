...
export type IncidentSource = "manual" | "zabbix";
...
export interface NocIncident {
  ...
  closed_at?: string | null;
  updated_at: string;
  assigned_user?: IncidentUserBrief | null;
  created_by_user?: IncidentUserBrief | null;
  alarms: ZabbixAlarm[];
}
...
export type TelegramAlertStatus = "sent" | "skipped" | "failed";
...
export interface TelegramAlertActionResult {
  alert: TelegramAlertLog;
  result: string;
  audit_entity_type: string;
}
