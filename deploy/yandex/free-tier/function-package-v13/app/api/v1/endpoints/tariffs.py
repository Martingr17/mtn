...
from app.dependencies import get_current_user, get_current_admin, require_roles
...
async def change_tariff(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_503_SERVICE_UNAVAILABLE, detail=f"Ошибка биллинга: {str(e)}")
...
async def admin_force_tariff_change(
    ...
    try:
        ...
        raise HTTPException(status_code=503, detail=f"Ошибка биллинга: {str(e)}")
