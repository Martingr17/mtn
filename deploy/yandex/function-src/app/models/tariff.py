from sqlalchemy import Column, BigInteger, String, SmallInteger, Numeric, Boolean, Text, DateTime, Integer, ForeignKey, Index
...
class Tariff(Base):
    ...
    speed_mbps = Column(SmallInteger, nullable=False, comment="Download speed in Mbps")
    upload_speed_mbps = Column(SmallInteger, nullable=True, comment="Upload speed in Mbps")
    ...
    contract_term_months = Column(SmallInteger, default=12, comment="Minimum contract term")
    ...
    features = Column(JSONB, default=[], comment="List of features")
    ...
    sort_order = Column(SmallInteger, default=0, comment="Display order")
