from sqlalchemy import Column, BigInteger, String, Boolean, DateTime, Text, Enum, Integer, ForeignKey, Index, SmallInteger
...
class Ticket(Base):
    ...
    satisfaction_rating = Column(SmallInteger, nullable=True, comment="Customer satisfaction rating 1-5")
    ...
    tags = Column(JSONB, default=[], comment="Ticket tags")
