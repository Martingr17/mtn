...
from app.api.v1.endpoints import (
    ...
    statistics, admin, webhooks, billing, health, search, speedtest, monitoring, radius, gpon, zabbix,
    incidents, telegram_alerts, audit,
    subscribers,
)
...
api_router.include_router(gpon.router)
api_router.include_router(zabbix.router)
api_router.include_router(incidents.router)
api_router.include_router(telegram_alerts.router)
