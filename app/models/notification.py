...
from app.db_compat import JsonType, enum_database_values
...
class Notification(Base):
    ...
    type = Column(
        Enum(NotificationType, values_callable=enum_database_values),
        default=NotificationType.EMAIL,
        nullable=False,
    )
    priority = Column(
        Enum(NotificationPriority, values_callable=enum_database_values),
    ...
    action_data = Column(JsonType, nullable=True, comment="Additional action data")
