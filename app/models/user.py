...
from app.db_compat import AwareTimestamp, IpAddressType, JsonType, enum_database_values
import bcrypt
...
class User(Base):
    ...
    connection_address = Column(String(512), nullable=True, comment="Subscriber service installation address")

    # Account status
    role = Column(
        Enum(UserRole, values_callable=enum_database_values),
