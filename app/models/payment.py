from sqlalchemy import Column, BigInteger, String, Numeric, DateTime, Enum, ForeignKey, Index, Text, Boolean
...
class PaymentLog(Base):
    ...
    status = Column(
        Enum(PaymentStatus, values_callable=enum_database_values),
